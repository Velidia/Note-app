...
val NoteTeal = Color(0xFFB2DFDB)
val NoteBlue = Color(0xFFBBDEFB)
val NoteCerulean = Color(0xFFB3E5FC)
val NotePurple = Color(0xFFD1C4E9)
val NotePink = Color(0xFFF8BBD0)
val NoteBrown = Color(0xFFD7CCC8)
val NoteGray = Color(0xFFCFD8DC)
